1;2c<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<!--
...
var slnum = 1;
slides[slnum++] = new Array(<?php print(($_REQUEST['delay'])?$_REQUEST['delay']:15)?>, "The WSIE", "http://www.infomous.com/site/mockups/slideshow/cloud-large.php?nid=22123");
slides[slnum++] = new Array(<?php print(($_REQUEST['delay'])?$_REQUEST['delay']:15)?>, "CNN Labels", "http://www.infomous.com/site/mockups/slideshow/cloud.php?nid=9979");
slides[slnum++] = new Array(<?php print(($_REQUEST['delay'])?$_REQUEST['delay']:15)?>, "TechCrunch", "http://www.infomous.com/site/mockups/slideshow/cloud.php?nid=11904");
slides[slnum++] = new Array(<?php print(($_REQUEST['delay'])?$_REQUEST['delay']:15)?>, "World News", "http://www.infomous.com/site/mockups/slideshow/cloud.php?nid=78");
//slides[slnum++] = new Array(<?php print(($_REQUEST['delay'])?$_REQUEST['delay']:15)?>, "Boston News", "http://www.infomous.com/site/mockups/slideshow/cloud.php?nid=590");
slides[slnum++] = new Array(<?php print(($_REQUEST['delay'])?$_REQUEST['delay']:15)?>, "Sports News", "http://www.infomous.com/site/mockups/slideshow/cloud.php?nid=1248");
