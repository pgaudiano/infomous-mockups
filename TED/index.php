...
$title="TED Talks: 2013 in Review - by Infomous";
$url="http://www.infomous.com/site/mockups/TED/";
$description="Explore TED Talks with Infomous";
$nid=16104;
$server="http://www.infomous.com/";
...
<head>
<title>TED Talks: 2013 | Infomous </title>
...
function infomous_ready(I) {
	...
	function update_date_text( step ) {
		...
		$( "#legend" ).html('<div style="text-align:center;font-weight:bold">Explore TED talks for ' + d1.toUTCString() + ' - ' + d2.toUTCString() + '</div>');
	}
...
<div id="debug" style="height:2em;"> </div>
  ...
  <div style="border: 1px solid #333333; margin-top:5px;">
    ...
    <div id="infomousMovie" style="border-style:none; margin-top:0px; height: 510px;">
      <script type="text/javascript" async data-infomous-id="nid<? print $nid ?>" src="<? print $server ?>client2/?width=950&height=500&maxWords=50"></script> 
    </div> 
	...
	<span class="item" style="width:156px;float:left">Jul</span>
	<span class="item" style="width:156px;float:left">Aug</span>
	<span class="item" style="width:156px;float:left">Sep</span>
	<span class="item" style="width:156px;float:left">Oct</span>
	<span class="item" style="width:156px;float:left">Nov</span>
	<span class="item" style="width:156px;float:left">Dec</span>
  ...
  <!-- Legend below the cloud --> <div id="cloud-legend"> <p>This <a
  href="http://www.infomous.com/what_is_infomous"><em>Infomous</em></a>
  cloud shows TED Talks for the second half of 2013, in two-week
  periods. Click any word to see links to related TED Talks (some
  talks have video and audio, some video only). Move the green dot in
  the time slider below the cloud to change time period between July
  and December 2013. If you are using a desktop you can also click the
  green dot and use the arrow keys to change the time period.</p> <p>If you have
  any questions or if you would like to use Infomous for your web site
  or for your event, please <a
  href="http://www.infomous.com/contact">contact us</a>.</p>

  </div>   <!-- End of Legend below the cloud -->

  <!-- Share links section -->
  <div id="share-links">
    Like this? Share it! &nbsp; &nbsp;   <a href="http://twitter.com/share" class="twitter-share-button" data-text="TED Talk Visual Explorer by Infomous" data-count="none">Tweet</a><script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script>
    &nbsp;
