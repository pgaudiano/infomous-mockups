...
$title="USA Today and NewsWhip - by Infomous";
$url="http://www.infomous.com/site/client/USAT/";
$description="Explore USA Today News with Infomous";
$nid=909;
...
<!--	<span class="item" style="width:135px;float:left">Jan</span>
	<span class="item" style="width:135px;float:left">Feb</span>
	<span class="item" style="width:135px;float:left">Mar</span>
	<span class="item" style="width:135px;float:left">Apr</span>
	<span class="item" style="width:135px;float:left">May</span> -->
	<span class="item" style="width:135px;float:left">Jun</span>
	<span class="item" style="width:135px;float:left">Jul</span>
	<span class="item" style="width:135px;float:left">Aug</span>
	<span class="item" style="width:135px;float:left">Sep</span>
	<span class="item" style="width:135px;float:left">Oct</span>
	<span class="item" style="width:135px;float:left">Nov</span>
	<span class="item" style="width:135px;float:left">Dec</span>
  ...
  <div id="cloud-legend">
    <p>This <a href="http://www.infomous.com/what_is_infomous"><em>Infomous</em></a>
      ...
      Today</a> and NewsWhip. Click any word to see a list of related articles from
