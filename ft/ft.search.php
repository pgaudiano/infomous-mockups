...
<title>Infomous Spotlighter from site: FT.com</title>
<style type="text/css">
body{
...
<?php 
if($_POST["search"])$search=rawurlencode(str_replace("+"," ",$_POST["search"]));else $search= "london";
if($_POST["numResults"])$numResults=$_POST["numResults"];else $numResults=40;
$urlencoded="http://www0.infomous.com/site/mockups/ft/xml.ft.php?search=$search&numResults=$numResults";
$ngrams="file:///var/www/infomous/site/mockups/ft/composite_words.txt";
?>

<div id="stylized" class="myform">
	<form method="post">
		<h1>Spotlighter creator from FT.com search</h1>
...
<input type="text" value="http://infomous.com/site/mockups/ft/<?=$search?><?=($numResults)?"/".$numResults:""?>">
<? }?>
...
<div id="infomous" class="infomous" style="margin:0px auto; border: 0px solid #000000"></div>
...
<!--      <?=($_POST["frame"])?"setFrame: true,":""?> -->
      ...
      ngramsSource: "<?=$ngrams?>",
      colLink: 0xeaeaea,
      <?if($_GET["v"]==1)echo 'textOption: "TITLE_AND_DESCRIPTION",';?>
      skinMaxFontSize: 42,
      skinMinFontSize: 14,
      setFrame: true
   }
