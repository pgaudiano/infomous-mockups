...
<div id="infomous-wrapper" style="background-image: url(http://www.infomous.com/site/mockups/London2012/ads/back_coke.jpg); border: 1px solid #999;">
...
<div id="infomous-actions" style="font-size: 10px; margin-top: 8px;">
  ...
  &nbsp;|&nbsp;
  <a onclick="window.open(\'http://www.infomous.com/site/mockups/London2012/ads/sports_coke_full.html\',\'_blank\',\'width=800,height=600,menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes\'); void(0);">OPEN IN NEW WINDOW</a>
</div>
