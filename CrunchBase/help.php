<?php 
$client_name='CrunchBase';
$client_logo='http://www.infomous.com/site/mockups/CrunchBase/CBlogo.jpg';
$client_link='http://www.crunchbase.com';
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
  <div style='background:#fff; width:700px; margin-top:20px;'>
    ...
    <div style="font-family:Arial, Helvetica, sans-serif padding-top: 2%; padding-left: 2%; padding-right: 2%;">
      ...
      <em>Visual Exploration</em> technology. This cloud is collecting tweets by <? print $client_name ?> to help you explore social media.</p>

      <p>Word size indicates how often that word occurs in the tweets. Related terms and concepts are linked together with lines.</p>

      <p>Click any word to show a list of tweets relevant to that word.</p>
