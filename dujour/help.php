<?php 
$client_name='DuJour';
$client_logo='http://www.infomous.com/site/mockups/dujour/logo.png';
$client_link='http://www.dujour.com';
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
  <div style='background:#fff; width:700px; margin-top:20px;'>
    ...
    <div style="font-family:Arial, Helvetica, sans-serif padding-top: 2%; padding-left: 2%; padding-right: 2%;">
      ...
      <em>Visual Exploration</em> technology. This cloud lets you explore recent content from <? print $client_name ?>.</p>
      ...
      <p>Find out more at <a href="http://www.infomous.com" target="_blank">the Infomous web site</a></p>
    </div>
  </div>
</body>
</html>
