...
$page = str_replace(
	...
	'<div style="border: 1px solid #CDDADD; background-color: #F4F8FA; margin-bottom: 15px; padding: 15px 0 0 0;">
    	<div class="title" style="font-size:1.3em; padding: 0 0 10px 10px;">
          <h3>Interact with The Economist Top Stories</h3>
        </div>
		<div id="movie"> </div>
		<script type="text/javascript" src="http://dev.infomous.com/site/economist/swfobject.js"></script>
         ...
         // <![CDATA[
            ...
            so.addVariable("feeds", "http%3A%2F%2Fwww.economist.com%2Frss%2Fdaily_news_and_views_rss.xml|http%3A%2F%2Fwww.economist.com%2Frss%2Fnews_analysis_rss.xml|http%3A%2F%2Fwww.economist.com%2Frss%2Fdaily_columns_rss.xml");
            ...
            function openSnippet(){
            	window.open("full_cloud2.html","_blank", "width=800,height=600,menubar=no,toolbar=no,resizable=no");
            }
         // ]]>
        </script>
