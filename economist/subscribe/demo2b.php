...
?>
  ...
  .container {
	...
	#ec_product_support_wrapper .ec_products_support_digital {
	    width: 200px;
	}
  #products-matrix table {
	    width: 500px;
	}
  #products-matrix table tr td.first-col {
	    width: 180px;
	}
	#products-matrix table tr.showinfo td div.service-wrapper p{
		width: 485px;
	}
	.products-subscribe{
		background: none;
	}
	#products-matrix #ec_product_matrix_prices .form-submit {
	    width: 120px;
	}
	#products-matrix #ec_product_matrix_prices {
	    width: auto !important;
	}
	#products-matrix #ec_product_matrix_prices td {
	    width: auto !important;
	}
	#products-matrix table td div.service-wrapper p span.service-description {
	    display: none;
	}
	#infomous{
