...
do
    ...
    url="http://economist.infomous.com/site/economist/proxy.php?type=rss&url=void&maxWords=50&linkageThreshold=1&textOption=TITLE_ONLY&dict=NOUN|1,VERB|1,ADJECTIVE|0,ADVERB|0,NUMBER|0,OTHER|1&fromDaysBack=${i}&toDaysBack=0"
