...
/* This portion of the code is executed when the script is invoked without a URL parameter.
   It explains what the script does and includes inputs to create the mockup page */
if(!isset($_GET["url"]))
{
?>
...
<p>
<input type="checkbox" name="top" value="true" checked>Include Wired Top Stories
...
// Now fetch the page. If needed, add a <base href> tag to make sure relative links work
...
$matchstring='<div class="OUTBRAIN"';
...
// Check to see if something has changed on the wired.com page - there will be a mismatch.
...
// Finally, print out the updated page.
echo $page;
