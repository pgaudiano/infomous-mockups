...
$client_name = 'Wired';
$client_logo = 'http://www.infomous.com/site/mockups/wired/wired_logo.gif';
$client_link = 'http://www.wired.com';
$inputfile = 'http://www.wired.com/2014/09/apple-watch-history/';
...
<input type="checkbox" name="tags"> Include Tag Feeds<br>
<input type="checkbox" name="labels"> Show Feed Labels<br>
